...
<link rel="icon"
	...
	<link rel="stylesheet"
		...
		<!-- 固定表头使用 -->
	<%-- <link rel="stylesheet"
		href="${pageContext.request.contextPath}/web/css/boot.css" /> --%>
</head>
<body>
...
<!--bootstrap-->
	...
	<jsp:include page="header.jsp"></jsp:include>
											...
											<div class="modal-body">												
												<div class="row rowNumb4  magin-bottom" >									
													  <div class="col-xs-12 col-sm-12  magin-bottom ">
														<div class="table4 clearFloat scroll_table_content" id="scroll_wrap">
															
															<table id="allData4"  class="top_fix_table table table-hover table-bordered table-striped table-condensed ">
																<thead >
																 <th></th>
																</thead>
																<tbody></tbody>
				...
				<div class="container">
						<jsp:include page="twoNav2.jsp"></jsp:include>
						<div class="row">
	...
	<!-- ajax调取数据相关js -->
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/web/js/data2.js"></script>	
	<!-- 最新的 Bootstrap 核心 JavaScript 文件 -->
	<script
		src="${pageContext.request.contextPath}/web/js/framework/bootstrap.min.js"></script>
	<!-- 捕获文件下载 -->
	...
	<!-- 固定表头使用 -->
	<%-- <script src="${pageContext.request.contextPath}/web/js/bootstrap-table.js"></script> --%>
