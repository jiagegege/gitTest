...
<div class="row twoNav">
	<ul class="nav nav-tabs">
	  <li role="presentation" class="active twoNav_a">
	  	<a href="${pageContext.request.contextPath}/main/counts.do?two=0">
	  	  15分钟 
	  	</a>
  	  </li>
	  <li role="presentation" class="keyPoint15 twoNav_a">
	  	<a href="${pageContext.request.contextPath}/main/counts.do?two=1">
	  	  <!-- 15分钟重点 -->
	  	  小时
	  	</a>
	  </li>
	  <li role="presentation" class="twoNav_a keyPointHour">
	  	<a href="${pageContext.request.contextPath}/main/counts.do?two=2">
	  		<!-- 小时 -->
	  		天
	  	</a>
	  </li>
